...
public class Juego {
    ...
    public void inicializarDescripciones(){
        ...
        this.descripciones.add("<html>Acepta varios parámetros de entrada, pero solo retorna sólo un valor de salida.</html>");
        ...
        this.descripciones.add("<html>Dentro de una empresa dedicada a la informática, es un tipo de programador.</html>");
        this.descripciones.add("<html>Conjunto de elementos relacionados entre sí<br>que tienen un cierto orden u organización y que cumplen una función, formando un todo.<html>");
    }
